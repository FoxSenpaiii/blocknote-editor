...
import { Constants, VDITOR_VERSION } from '$const';
import { DevTools } from '$comp/devtools/index';
import { Hint } from '$comp/hint/index';
import { IR } from '$comp/ir/index';
import { input as irInput } from '$comp/ir/input';
import { processAfterRender } from '$comp/ir/process';
import { getHTML } from '$comp/markdown/getHTML';
import { getMarkdown } from '$comp/markdown/getMarkdown';
import { setLute } from '$comp/markdown/setLute';
import { Outline } from '$comp/outline/index';
import { Preview } from '$comp/preview/index';
import { Resize } from '$comp/resize/index';
import { Editor } from '$comp/sv/index';
import { inputEvent } from '$comp/sv/inputEvent';
import { processAfterRender as processSVAfterRender } from '$comp/sv/process';
import { Tip } from '$comp/tip/index';
import { Toolbar } from '$comp/toolbar/index';
import { disableToolbar, hidePanel, enableToolbar } from '$comp/toolbar/setToolbar';
import { initUI, UIUnbindListener } from '$comp/ui/initUI';
import { setCodeTheme } from '$comp/ui/setCodeTheme';
import { setContentTheme } from '$comp/ui/setContentTheme';
import { setPreviewMode } from '$comp/ui/setPreviewMode';
import { setTheme } from '$comp/ui/setTheme';
import { Undo } from '$comp/undo/index';
...
import { WYSIWYG } from '$comp/wysiwyg/index';
import { input } from '$comp/wysiwyg/input';
import { renderDomByMd } from '$comp/wysiwyg/renderDomByMd';
import { IEditor, IEditorOptions, II18n } from '$type';
...
class Vditor extends VditorMethod {
	...
	private init(id: HTMLElement, mergedOptions: IEditorOptions) {
		this.vditor = {
