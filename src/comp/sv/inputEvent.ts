...
export const inputEvent = (vditor: IEditor, event?: InputEvent) => {
	...
	if (blockElement && event && (event.inputType === 'deleteContentBackward' || event.data === ' ')) {
		...
		if (event.inputType === 'deleteContentBackward') {
			...
			const mathBlockMarkerElement = hasClosestByAttribute(startContainer, 'data-type', 'math-block-open-marker');
