...
export class Headings extends MenuItem {
	...
	constructor(vditor: IEditor, menuItem: IMenuItem) {
		...
		panelElement.innerHTML = `<button data-tag="h1" data-value="# ">${window.VditorI18n.heading1} ${updateHotkeyTip(
			'&lt;⌥⌘1>'
		)}</button>
...
<button data-tag="h6" data-value="###### ">${window.VditorI18n.heading6} &lt;${updateHotkeyTip('⌥⌘6')}></button>`;
	...
	public _bindEvent(vditor: IEditor, panelElement: HTMLElement) {
