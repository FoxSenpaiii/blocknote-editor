...
export abstract class Constants {
	...
	public static readonly CLASS_MENU_DISABLED: string = 'editor-menu--disabled';
	...
	public static readonly CDN = `https://unpkg.com/editor@${VDITOR_VERSION}`;
