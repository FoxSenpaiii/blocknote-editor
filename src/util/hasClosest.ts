...
export const hasClosestByAttribute = (element: Node | null, attr: string, value: string) => {
    if (!element) {
        return false;
    }
    ...
    let e = element as HTMLElement | null;
    let isClosest = false;
...
export const hasClosestBlock = (element: Node | null) => {
    if (!element) {
        return false;
    }
    if (element.nodeType === 3) {
...
export const hasClosestByMatchTag = (element: Node | null, nodeName: string) => {
    if (!element) {
        return false;
    }
    if (element.nodeType === 3) {
...
export const hasClosestByClassName = (element: Node | null, className: string) => {
    if (!element) {
        return false;
    }
    if (element.nodeType === 3) {
