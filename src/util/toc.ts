...
export const renderToc = (vditor: IEditor) => {
...
export const clickToc = (event: MouseEvent & { target: HTMLElement }, vditor: IEditor) => {
...
export const keydownToc = (blockElement: HTMLElement, vditor: IEditor, event: KeyboardEvent, range: Range) => {
	// toc 前无元素，插入空块
